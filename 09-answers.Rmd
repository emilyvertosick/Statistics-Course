...
```{r week3r, include = FALSE, purl = FALSE}
...
```{r week3t, echo = FALSE, purl = FALSE}
...
```{r week6a, echo = FALSE, warning = FALSE, results = "asis", purl = FALSE}
...
tbl_markermodel <-
  tbl_summary(
    ...
    by = "hi_risk",
    type = list(vars(markermodel_hirisk) ~ "categorical"),
    statistic = list(vars(markermodel_hirisk) ~ "{n}")
  )
...
tbl_imaging <-
  tbl_summary(
    ...
    by = "markermodel_hirisk",
    type = list(vars(imagingmodel_hirisk) ~ "categorical"),
    statistic = list(vars(imagingmodel_hirisk) ~ "{n}")
  )
