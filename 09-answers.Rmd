...
# High vs medium
tbl_himed <- epi.2by2(matrix(rev(table(lesson4b$c, lesson4b$hbp)), nrow = 2))
...
tbl_hilo <- epi.2by2(matrix(rev(table(lesson4b$c, lesson4b$hbp)), nrow = 2))
...
tbl_medlo <- epi.2by2(matrix(rev(table(lesson4b$c, lesson4b$hbp)), nrow = 2))
...
tbl_chemoresponse <-
  tbl_summary(
    ...
    by = "response",
    type = list(group = "categorical"),
    statistic = list(group = "{p}%")
  )
...
tbl_markermodel <-
  tbl_summary(
    ...
    by = "hi_risk",
    type = list(model_hirisk2 = "categorical"),
    statistic = list(model_hirisk2 = "{n}")
  )
...
tbl_imaging <-
  tbl_summary(
    ...
    by = "model_hirisk2",
    type = list(model_hirisk3 = "categorical"),
    statistic = list(model_hirisk3 = "{n}")
  )
...
tbl_summary_7a <-
  tbl_summary(
    ...
    type = list(sex = "categorical", obstruction = "categorical",
                adhesions = "categorical"),
    label = list(sex = "Sex", age = "Age",
                 obstruction = "Obstruction", adhesions = "Adhesions",
                 node4 = "Number of nodes")
  )
