...
This simple command gives us our first lesson about the dangers of statistical software: it gives the age to within a few days. So if you were reporting results for a journal, you would never say that mean age was `r skim(lesson1a$age)$value[[4]]`, you’d probably just say `r round(skim(lesson1a$age)$value[[4]], 0)`.
