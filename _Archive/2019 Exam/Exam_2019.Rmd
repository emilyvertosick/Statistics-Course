...
```{r exam1, echo = FALSE, results = "asis"}
...
```{r exam2, echo = FALSE, results = "asis"}
...
```{r exam3, echo = FALSE, results = "asis"}
...
tbl3 <-
  ...
  gt() %>%
  cols_label(col1 = "Covariate", col2 = "Odds Ratio",
             col3 = "Std. Err.", col4 = "z",
             col5 = "P>z", col6 = "95% Conf. Interval")
