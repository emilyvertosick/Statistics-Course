...
```{r loadpkgs2, echo = TRUE, eval = FALSE}
...
The first row of the results says that you are looking at the 0, 25, 50, 75, and 100 centiles, i.e. the minimum and maximum, and the medium and quartiles. The second row gives you the actual values. So you could report this as “Median age was `r quantile(lesson1a$age, na.rm = TRUE)[[3]]` (quartiles `r quantile(lesson1a$age, na.rm = TRUE)[[2]]`, `r quantile(lesson1a$age, na.rm = TRUE)[[4]]`)."
...
```{r section2g, echo = FALSE, results = "hide"}
...
This shows that, for example, `r inline_text(tbl_sex_y3, variable = "sex", level = "0", column = "harding")` men and `r inline_text(tbl_sex_y3, variable = "sex", level = "1", column = "harding")` women had operations at the "Harding" site.
