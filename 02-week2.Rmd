...
So you can tell you have data on age for `r nrow(lesson1a)` patients ("number of rows" is the number of observations), the mean age was about `r round(skim(lesson1a$age) %>% pull(numeric.mean), 0)` years, and the standard deviation of the mean was about `r round(skim(lesson1a$age) %>% pull(numeric.sd), 1)`.
